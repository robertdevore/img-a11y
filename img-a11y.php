    ...
    if ( $notice_link ) {
        ...
        <div class="notice notice-error">
            <p>
                ...
                echo wp_kses_post(
                    sprintf(
                        __( 'My Plugin has been deactivated because it cannot be used on WordPress.com-hosted websites. %s', 'img-a11y' ),
                        '<a href="' . esc_url( $notice_link ) . '" target="_blank" rel="noopener">' . __( 'Learn more', 'img-a11y' ) . '</a>'
                    )
                );
                ?>
            </p>
        ...
        wp_die(
            wp_kses_post(
                sprintf(
                    ...
                    __( 'Plugin Activation Blocked', 'img-a11y' ),
                    __( 'This plugin cannot be activated on WordPress.com-hosted websites. It is restricted due to concerns about WordPress.com policies impacting the community.', 'img-a11y' ),
                    esc_url( 'https://robertdevore.com/why-this-plugin-doesnt-support-wordpress-com-hosting/' ),
                    __( 'Learn more', 'img-a11y' )
                )
            ),
            esc_html__( 'Plugin Activation Blocked', 'img-a11y' ),
            [ 'back_link' => true ]
        );
    }
}
